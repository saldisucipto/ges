            ...
            <ul class="bxslider">
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="{{asset('frontend_assets/img/dummies/testimonial/1.png')}}" alt="" />
                  <h4>Hillary Doe</h4>
              ...
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="{{asset('frontend_assets/img/dummies/testimonial/2.png')}}" alt="" />
                  <h4>Michael Doe</h4>
                  <a href="#">www.companyname.com</a>
                </div>
              </li>
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="{{asset('frontend_assets/img/dummies/testimonial/3.png')}}" alt="" />
                  <h4>Mark Donovan</h4>
                  <a href="#">www.companyname.com</a>
                </div>
              </li>
              <li>
                ...
                <div class="testimonial-autor">
                  <img src="{{asset('frontend_assets/img/dummies/testimonial/4.png')}}" alt="" />
